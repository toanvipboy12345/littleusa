...
const Checkout = () => {
  ...
  const [maxDiscountAmount, setMaxDiscountAmount] = useState(null); // Thêm state cho maxDiscountAmount
  ...
  // Validate coupon với maxDiscountAmount
  const handleValidateCoupon = async () => {
    ...
    try {
      ...
      setMaxDiscountAmount(coupon.maxDiscountAmount); // Lưu maxDiscountAmount
      toast({
        title: "Thành công",
  ...
  // Tính toán phí vận chuyển và giảm giá với maxDiscountAmount
  ...
  if (maxDiscountAmount !== null && discountAmount > maxDiscountAmount) {
    discountAmount = maxDiscountAmount; // Áp dụng giới hạn tối đa
  }
